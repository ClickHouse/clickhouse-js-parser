...
INSERT INTO words SELECT *
FROM generateRandom('i Int, word String', 1, 10)
LIMIT 1 BY i
LIMIT 10000;

CREATE TABLE zstd_1_00
(
    n Int,
    b String CODEC(ZSTD(1))
)
ENGINE = MergeTree()
ORDER BY n;
...
CREATE TABLE zstd_9_00
(
    n Int,
    b String CODEC(ZSTD(9))
)
ENGINE = MergeTree()
ORDER BY n;
...
INSERT INTO zstd_1_00 SELECT *
FROM words;

INSERT INTO zstd_1_24 SELECT *
FROM words;

INSERT INTO zstd_9_00 SELECT *
FROM words;

INSERT INTO zstd_9_24 SELECT *
FROM words;
