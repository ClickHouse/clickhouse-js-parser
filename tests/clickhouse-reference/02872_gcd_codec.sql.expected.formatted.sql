...
INSERT INTO table_gcd_codec_uint16 SELECT number
FROM `system`.numbers
LIMIT 50;

INSERT INTO table_gcd_codec_uint32 SELECT number
FROM `system`.numbers
LIMIT 50;

INSERT INTO table_gcd_codec_uint64 SELECT number
FROM `system`.numbers
LIMIT 50;

INSERT INTO table_gcd_codec_uint128 SELECT number
FROM `system`.numbers
LIMIT 50;

INSERT INTO table_gcd_codec_uint256 SELECT number
FROM `system`.numbers
LIMIT 50;
...
INSERT INTO table_gcd_codec_int16 SELECT number
FROM `system`.numbers
LIMIT 50;

INSERT INTO table_gcd_codec_int32 SELECT number
FROM `system`.numbers
LIMIT 50;

INSERT INTO table_gcd_codec_int64 SELECT number
FROM `system`.numbers
LIMIT 50;

INSERT INTO table_gcd_codec_int128 SELECT number
FROM `system`.numbers
LIMIT 50;

INSERT INTO table_gcd_codec_int256 SELECT number
FROM `system`.numbers
LIMIT 50;
...
INSERT INTO table_gcd_codec_decimal64 SELECT number
FROM `system`.numbers
LIMIT 50;

INSERT INTO table_gcd_codec_decimal128 SELECT number
FROM `system`.numbers
LIMIT 50;

INSERT INTO table_gcd_codec_decimal256 SELECT number
FROM `system`.numbers
LIMIT 50;
...
INSERT INTO table_gcd_codec_date32 SELECT number
FROM `system`.numbers
LIMIT 50;
...
INSERT INTO table_gcd_codec_datetime64 SELECT number
FROM `system`.numbers
LIMIT 50;
