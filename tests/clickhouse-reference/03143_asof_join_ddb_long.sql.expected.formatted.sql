...
UNION ALL
SELECT
    toDateTime('1990-05-21 13:00:01') + toIntervalMinute(number) AS begin,
    1 AS key
FROM numbers(0, 10)
UNION ALL
SELECT
    toDateTime('1990-06-21 13:00:01') + toIntervalMinute(number) AS begin,
    2 AS key
FROM numbers(0, 20)
UNION ALL
SELECT
    toDateTime('1990-03-21 13:00:01') + toIntervalMinute(number) AS begin,
    3 AS key
FROM numbers(0, 4000000);
