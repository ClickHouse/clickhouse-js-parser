...
ENGINE = Distributed('test_cluster_thirty_shards_localhost', currentDatabase(), test_table_1, rand());

INSERT INTO dist_test_table_1 SELECT number
...
ENGINE = Distributed('test_cluster_thirty_shards_localhost', currentDatabase(), test_table_2, rand());

INSERT INTO dist_test_table_2 SELECT number
FROM numbers_mt(10000)
SETTINGS distributed_foreground_insert = '1';
