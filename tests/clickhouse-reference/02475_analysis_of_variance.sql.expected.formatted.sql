SELECT analysisOfVariance(number, number % 2)
FROM numbers(10)
FORMAT Null;

SELECT analysisOfVariance(number::Decimal32(5), number % 2)
FROM numbers(10)
FORMAT Null;

SELECT analysisOfVariance(number::Decimal256(5), number % 2)
FROM numbers(10)
FORMAT Null;
...
SELECT
    ...
    analysisOfVariance(100000000000000000000., number % 65535)
FROM numbers(1048575);