...
SELECT corr(c1, c2)
FROM VALUES((0, 0), (NULL, 2), (1, 0), (1, 1));

SELECT round(arrayJoin(categoricalInformationValue(c1, c2)), 3)
FROM VALUES((0, 0), (NULL, 2), (1, 0), (1, 1));

SELECT round(arrayJoin(categoricalInformationValue(c1, c2)), 3)
FROM VALUES((0, 0), (NULL, 1), (1, 0), (1, 1));
...
SELECT categoricalInformationValue(c1, c2)
FROM VALUES((toNullable(0), 0));

SELECT groupUniqArray(*)
FROM VALUES(toNullable(0));
