...
ALTER TABLE table_for_alter MODIFY SETTING check_delay_period = '30';

ALTER TABLE table_for_alter ADD COLUMN Data2 UInt64, MODIFY SETTING check_delay_period = '15';
