...
SELECT lambda(1); -- { serverError MULTIPLE_EXPRESSIONS_FOR_ALIAS }

WITH x -> x + 1 AS lambda

SELECT (
        SELECT 1
    ) AS lambda; -- { serverError MULTIPLE_EXPRESSIONS_FOR_ALIAS }

WITH x -> x + 1 AS lambda

SELECT 1 AS lambda; -- { serverError MULTIPLE_EXPRESSIONS_FOR_ALIAS }
