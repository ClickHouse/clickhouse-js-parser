...
SELECT
    quantileExactLow(0.2)(a),
    quantileExactLow(0.2)(b),
    quantileExactLow(0.2)(c)
FROM decimal
WHERE a >= 0;

SELECT
    quantileExactLow(0.4)(a),
    quantileExactLow(0.4)(b),
    quantileExactLow(0.4)(c)
FROM decimal
WHERE a >= 0;

SELECT
    quantileExactLow(0.6)(a),
    quantileExactLow(0.6)(b),
    quantileExactLow(0.6)(c)
FROM decimal
WHERE a >= 0;

SELECT
    quantileExactLow(0.8)(a),
    quantileExactLow(0.8)(b),
    quantileExactLow(0.8)(c)
FROM decimal
WHERE a >= 0;
...
SELECT
    quantileExactHigh(0.2)(a),
    quantileExactHigh(0.2)(b),
    quantileExactHigh(0.2)(c)
FROM decimal
WHERE a >= 0;

SELECT
    quantileExactHigh(0.4)(a),
    quantileExactHigh(0.4)(b),
    quantileExactHigh(0.4)(c)
FROM decimal
WHERE a >= 0;

SELECT
    quantileExactHigh(0.6)(a),
    quantileExactHigh(0.6)(b),
    quantileExactHigh(0.6)(c)
FROM decimal
WHERE a >= 0;

SELECT
    quantileExactHigh(0.8)(a),
    quantileExactHigh(0.8)(b),
    quantileExactHigh(0.8)(c)
FROM decimal
WHERE a >= 0;
...
SELECT
    medianExactWeighted(a, 1),
    medianExactWeighted(b, 2),
    medianExactWeighted(c, 3) AS x,
    toTypeName(x)
FROM decimal;

SELECT
    quantileExactWeighted(a, 1),
    quantileExactWeighted(b, 2),
    quantileExactWeighted(c, 3) AS x,
    toTypeName(x)
FROM decimal
WHERE a < 0;
...
SELECT
    quantileExactWeighted(0.2)(a, 1),
    quantileExactWeighted(0.2)(b, 2),
    quantileExactWeighted(0.2)(c, 3)
FROM decimal
WHERE a >= 0;

SELECT
    quantileExactWeighted(0.4)(a, 1),
    quantileExactWeighted(0.4)(b, 2),
    quantileExactWeighted(0.4)(c, 3)
FROM decimal
WHERE a >= 0;

SELECT
    quantileExactWeighted(0.6)(a, 1),
    quantileExactWeighted(0.6)(b, 2),
    quantileExactWeighted(0.6)(c, 3)
FROM decimal
WHERE a >= 0;

SELECT
    quantileExactWeighted(0.8)(a, 1),
    quantileExactWeighted(0.8)(b, 2),
    quantileExactWeighted(0.8)(c, 3)
FROM decimal
WHERE a >= 0;
...
SELECT
    stddevPop(toFloat64(a)),
    stddevPop(toFloat64(b)),
    stddevPop(toFloat64(c))
FROM decimal;
...
SELECT
    stddevSamp(toFloat64(a)),
    stddevSamp(toFloat64(b)),
    stddevSamp(toFloat64(c))
FROM decimal;
