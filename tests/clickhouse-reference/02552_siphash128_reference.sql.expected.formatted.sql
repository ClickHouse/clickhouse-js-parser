...
SELECT hex(sipHash128ReferenceKeyed(key, CAST('4' AS UInt64)))
FROM tab;
...
SELECT hex(sipHash128ReferenceKeyed((CAST('2' AS UInt64), CAST('2' AS UInt64)), val))
FROM sipHashKeyed_keys
ORDER BY val ASC;
...
SELECT hex(sipHash128ReferenceKeyed((key0, key1), CAST('4' AS UInt64)))
FROM sipHashKeyed_keys
ORDER BY key0 ASC;