...
SELECT
    number,
    anyIf(toNullable('Hello'), arrayJoin([1, NULL]) = 0)
FROM numbers(2)
GROUP BY number
ORDER BY number ASC;
...
SELECT
    number,
    anyIf(toNullable('Hello'), arrayJoin([1, NULL, 0]) = 0)
FROM numbers(2)
GROUP BY number
ORDER BY number ASC;
...
SELECT
    number,
    anyIf('Hello', arrayJoin([1, NULL]) = 0)
FROM numbers(2)
GROUP BY number
ORDER BY number ASC;
...
SELECT
    number,
    anyIf('Hello', arrayJoin([1, NULL, 0]) = 0)
FROM numbers(2)
GROUP BY number
ORDER BY number ASC;
...
SELECT
    number,
    anyIf(toNullable('Hello'), arrayJoin([1, 1]) = 0)
FROM numbers(2)
GROUP BY number
ORDER BY number ASC;
...
SELECT
    number,
    anyIf(toNullable('Hello'), arrayJoin([1, 0]) = 0)
FROM numbers(2)
GROUP BY number
ORDER BY number ASC;
