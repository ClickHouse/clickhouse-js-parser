...
SELECT concatWithSeparator('|', 'a', materialize(CAST('42' AS Int8))) = 'a|42';

SELECT concatWithSeparator('|', 'a', materialize(CAST('43' AS Int16))) = 'a|43';

SELECT concatWithSeparator('|', 'a', materialize(CAST('44' AS Int32))) = 'a|44';

SELECT concatWithSeparator('|', 'a', materialize(CAST('45' AS Int64))) = 'a|45';

SELECT concatWithSeparator('|', 'a', materialize(CAST('46' AS Int128))) = 'a|46';

SELECT concatWithSeparator('|', 'a', materialize(CAST('47' AS Int256))) = 'a|47';

SELECT concatWithSeparator('|', 'a', materialize(CAST('48' AS UInt8))) = 'a|48';

SELECT concatWithSeparator('|', 'a', materialize(CAST('49' AS UInt16))) = 'a|49';

SELECT concatWithSeparator('|', 'a', materialize(CAST('50' AS UInt32))) = 'a|50';

SELECT concatWithSeparator('|', 'a', materialize(CAST('51' AS UInt64))) = 'a|51';

SELECT concatWithSeparator('|', 'a', materialize(CAST('52' AS UInt128))) = 'a|52';

SELECT concatWithSeparator('|', 'a', materialize(CAST('53' AS UInt256))) = 'a|53';

SELECT concatWithSeparator('|', 'a', materialize(CAST('42.42' AS Float32))) = 'a|42.42';

SELECT concatWithSeparator('|', 'a', materialize(CAST('43.43' AS Float64))) = 'a|43.43';

SELECT concatWithSeparator('|', 'a', materialize(CAST('44.44' AS Decimal(2)))) = 'a|44';
...
SELECT concatWithSeparator('|', 'a', materialize(CAST('42' AS LowCardinality(Nullable(UInt32))))) = 'a|42';

SELECT concatWithSeparator('|', 'a', materialize(CAST('42' AS LowCardinality(UInt32)))) = 'a|42';
...
SELECT concatWithSeparator('|', 'a', materialize(CAST('[''foo'', ''bar'']' AS Array(String)))) = 'a|[''foo'',''bar'']';

SELECT concatWithSeparator('|', 'a', materialize(CAST('(42, ''foo'')' AS Tuple(Int32, String)))) = 'a|(42,''foo'')';
