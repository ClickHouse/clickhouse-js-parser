...
INSERT INTO FUNCTION file(currentDatabase() || '_table_time_bug.csv', 'CSV', 'c3 Int, c2 Int128, c1 Time, c0 Int') SELECT
    c3,
    c2,
    c1,
    c0
...
INSERT INTO t0 (c0, c1, c2, c3) SELECT
    ...
    c2,
    c3
FROM file(currentDatabase() || '_table_time_bug.csv', 'CSV', 'c0 Int, c1 Time, c2 Int128, c3 Int');