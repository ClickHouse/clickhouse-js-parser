...
FROM (
        ...
        FROM (
                ...
                QUALIFY delta_sum = ignore(ignore(materialize(1023), *, *, toUInt256(10), *, *, 10, *, toUInt256(toUInt128(10)), 10 IS NOT NULL, 10, 10, 10, 10, materialize(toNullable(toUInt128(10))), *, isNullable(NULL), 10))
            )
        ORDER BY
            1 DESC,
            ignore(*, *, 10, *, 10, 10, 10, 10, 10, *, toUInt128(10), 10, *, 10, NULL IS NULL, 10, 10) ASC NULLS FIRST,
            x ASC
    )
