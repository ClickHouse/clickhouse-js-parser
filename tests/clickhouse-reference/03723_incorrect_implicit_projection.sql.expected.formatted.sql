...
INSERT INTO prd_bid_events_simple_no_partition SELECT
    arrayElement(['impression', 'start', 'firstQuartile', 'midpoint', 'thirdQuartile', 'complete', 'ad_request', 'random_value'], 1 + number % 8),
