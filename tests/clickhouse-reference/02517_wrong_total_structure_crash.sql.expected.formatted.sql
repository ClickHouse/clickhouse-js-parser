...
CREATE OR REPLACE TABLE alias10__fuzz_13
(
    Id Array(Array(UInt256)),
    EventDate Array(String),
    field1 Array(Array(Nullable(Int8))),
    field2 Array(Date),
    field3 Array(Array(Array(UInt128)))
)
...
ENGINE = Distributed(test_shard_localhost, currentDatabase(), local);
