...
SELECT
    col,
    mapFilter(((k, v) -> v % 10 > 1), col)
FROM table_map
ORDER BY id ASC;

SELECT mapApply(((k, v) -> (k, v + 1)), col)
FROM table_map
ORDER BY id ASC;

SELECT mapFilter(((k, v) -> 0), col)
FROM table_map;

SELECT mapApply(((k, v) -> tuple(v + 9223372036854775806)), col)
FROM table_map; -- { serverError BAD_ARGUMENTS }

SELECT mapFilter(((k, v) -> k = CAST('0.1' AS Float32)), map(CAST('0.1' AS Float32), 4, CAST('0.2' AS Float32), 5));

SELECT mapFilter(((k, v) -> k = CAST('0.1' AS Float64)), map(CAST('0.1' AS Float64), 4, CAST('0.2' AS Float64), 5));
...
SELECT mapExists(((k, v) -> k = CAST('0.1' AS Float32)), map(CAST('0.1' AS Float32), 4, CAST('0.2' AS Float32), 5));

SELECT mapExists(((k, v) -> k = CAST('0.1' AS Float64)), map(CAST('0.1' AS Float64), 4, CAST('0.2' AS Float64), 5));
...
SELECT mapAll(((k, v) -> k = CAST('0.1' AS Float32)), map(CAST('0.1' AS Float32), 4, CAST('0.2' AS Float32), 5));

SELECT mapAll(((k, v) -> k = CAST('0.1' AS Float64)), map(CAST('0.1' AS Float64), 4, CAST('0.2' AS Float64), 5));
...
SELECT mapSort(((k, v) -> k), map(CAST('0.1' AS Float32), 4, CAST('0.2' AS Float32), 5));

SELECT mapSort(((k, v) -> k), map(CAST('0.1' AS Float64), 4, CAST('0.2' AS Float64), 5));
...
SELECT mapConcat(col, map('key5', 500), map('key6', 600))
FROM table_map
ORDER BY id ASC;

SELECT mapConcat(col, materialize(map('key5', 500)), map('key6', 600))
FROM table_map
ORDER BY id ASC;
...
SELECT mapConcat(map(CAST('0.1' AS Float32), 4), map(CAST('0.2' AS Float32), 5));

SELECT mapConcat(map(CAST('0.1' AS Float64), 4), map(CAST('0.2' AS Float64), 5));
...
SELECT mapExists(((k, v) -> k LIKE '%3'), col)
FROM table_map
ORDER BY id ASC;

SELECT mapExists(((k, v) -> k LIKE '%2'
    AND v < 1000), col)
FROM table_map
ORDER BY id ASC;

SELECT mapAll(((k, v) -> k LIKE '%3'), col)
FROM table_map
ORDER BY id ASC;

SELECT mapAll(((k, v) -> k LIKE '%2'
    AND v < 1000), col)
FROM table_map
ORDER BY id ASC;
...
SELECT mapSort(((k, v) -> v), col)
FROM table_map
ORDER BY id ASC;

SELECT mapPartialSort(((k, v) -> k), 2, col)
FROM table_map
ORDER BY id ASC;
