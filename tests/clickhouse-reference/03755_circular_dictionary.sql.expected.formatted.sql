...
WHERE metric IN (
        SELECT metric
        FROM background_dict
    );

INSERT INTO ddlworker_metrics SELECT
    metric,
    value
FROM `system`.metrics
WHERE metric IN (
...
INSERT INTO distrcache_metrics SELECT
    metric,
    value
FROM `system`.metrics
WHERE metric IN (
        SELECT metric
        FROM distrcache_dict
    );

INSERT INTO drop_metrics SELECT
    metric,
    value
FROM `system`.metrics
WHERE metric IN (
...
INSERT INTO filesystem_metrics SELECT
    metric,
    value
FROM `system`.metrics
WHERE metric IN (
        SELECT metric
        FROM filesystem_dict
    );

INSERT INTO kafka_metrics SELECT
    metric,
    value
FROM `system`.metrics
WHERE metric IN (
...
INSERT INTO mergetree_metrics SELECT
    metric,
    value
FROM `system`.metrics
WHERE metric IN (
...
INSERT INTO parts_metrics SELECT
    metric,
    value
FROM `system`.metrics
WHERE metric IN (
...
INSERT INTO storages3_metrics SELECT
    metric,
    value
FROM `system`.metrics
WHERE metric IN (
...
INSERT INTO temporaryfiles_metrics SELECT
    metric,
    value
FROM `system`.metrics
WHERE metric IN (
