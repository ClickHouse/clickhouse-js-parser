...
INSERT INTO tab SELECT
    number,
    'c1' || toString(number),
    'c2' || toString(number + 1)
FROM numbers(10000);

ALTER TABLE tab ADD INDEX idx_c1 c1 TYPE text(tokenizer = ngrams(3)) GRANULARITY 100000000;

ALTER TABLE tab ADD INDEX idx_c2 c2 TYPE text(tokenizer = ngrams(3)) GRANULARITY 100000000;
