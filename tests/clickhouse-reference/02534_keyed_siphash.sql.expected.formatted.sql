...
SELECT sipHash64Keyed(key, CAST('4' AS UInt64))
FROM tab;

SELECT hex(sipHash128Keyed(key, val))
FROM tab;

SELECT hex(sipHash128Keyed(key, CAST('4' AS UInt64)))
FROM tab;

DROP TABLE tab;

SELECT sipHash64Keyed((CAST('2' AS UInt64), toUInt64(2)), 4)
GROUP BY toUInt64(2);
...
SELECT sipHash64Keyed((toUInt64(9223372036854775806), CAST('9223372036854775808' AS UInt64)), char(2))
...
SELECT sipHash64Keyed((CAST('2' AS UInt64), CAST('2' AS UInt64)), val)
FROM sipHashKeyed_keys
ORDER BY val ASC;

SELECT hex(sipHash128Keyed((CAST('2' AS UInt64), CAST('2' AS UInt64)), val))
FROM sipHashKeyed_keys
ORDER BY val ASC;
...
SELECT sipHash64Keyed((key0, key1), CAST('4' AS UInt64))
FROM sipHashKeyed_keys
ORDER BY key0 ASC;

SELECT hex(sipHash128Keyed((key0, key1), CAST('4' AS UInt64)))
FROM sipHashKeyed_keys
ORDER BY key0 ASC;

SELECT sipHash128((toUInt64(9223372036854775806), 1)) = sipHash128(1)
GROUP BY
    sipHash128(CAST('1' AS UInt8)),
...
SELECT hex(sipHash128ReferenceKeyed((CAST('0' AS UInt64), CAST('0' AS UInt64)), [1, 1]));
...
INSERT INTO sipHashKeyed_keys FORMAT VALUES;

SELECT hex(sipHash128ReferenceKeyed((CAST('0' AS UInt64), materialize(CAST('0' AS UInt64))), a))
FROM sipHashKeyed_keys
ORDER BY a ASC;

SELECT sipHash64Keyed((CAST('1' AS UInt64), CAST('2' AS UInt64)), []);

SELECT hex(sipHash128Keyed((CAST('1' AS UInt64), CAST('2' AS UInt64)), []));

SELECT sipHash64Keyed((CAST('1' AS UInt64), CAST('2' AS UInt64)), mapFromArrays([], []));

SELECT hex(sipHash128Keyed((CAST('1' AS UInt64), CAST('2' AS UInt64)), mapFromArrays([], [])));

SELECT sipHash64Keyed((CAST('1' AS UInt64), CAST('2' AS UInt64)), map([0], 1, [2], 3));

SELECT hex(sipHash128Keyed((CAST('1' AS UInt64), CAST('2' AS UInt64)), map([0], 1, [2], 3)));

SELECT sipHash64Keyed((materialize(CAST('1' AS UInt64)), CAST('2' AS UInt64)), map([0], 1, [2], 3))
FROM numbers(2);

SELECT hex(sipHash128Keyed((materialize(CAST('1' AS UInt64)), CAST('2' AS UInt64)), map([0], 1, [2], 3)))
FROM numbers(2);