...
-- Test overflow
SELECT materialize(toDateTime64('2262-04-11 23:47:16', 9, 'UTC')) - toDateTime64('1900-01-01 00:00:00', 9, 'UTC')
FORMAT Null; -- { serverError DECIMAL_OVERFLOW }

SELECT materialize(toDateTime64('1900-01-01 00:00:00', 0, 'UTC')) - materialize(toDateTime64('2262-04-11 23:47:16', 9, 'UTC')); -- { serverError DECIMAL_OVERFLOW }
