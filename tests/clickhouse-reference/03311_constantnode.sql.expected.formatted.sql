SELECT uniqUpTo(5)(CAST(unhex('00') AS AggregateFunction(uniqUpTo(5), Nullable(Nothing))));
...
SELECT map(('{"a":1,"b":1,"b":1}',), 1, ('{"a":1}',), 2, ('{"a":1,"c":1}',), 2666514966)::Map(Tuple(JSON(max_dynamic_paths = 2)), Variant(UInt32))
SETTINGS
