...
SELECT
    flattenTuple(CAST(NULL AS Nullable(Tuple(a Int32, b Array(Int32))))) AS res,
    toTypeName(res),
    isNull(res);

SELECT
    flattenTuple(CAST((1, ('x', NULL)) AS Nullable(Tuple(a Int32, b Nullable(Tuple(String, Nullable(Tuple(Int32, Nullable(Int32))))))))) AS res,
    toTypeName(res),
    isNull(res);