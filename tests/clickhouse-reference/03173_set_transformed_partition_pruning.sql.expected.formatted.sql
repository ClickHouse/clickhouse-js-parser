...
INSERT INTO `03173_single_function` SELECT toDate('2000-01-01') + 10 * number
FROM numbers(50)
UNION ALL
...
INSERT INTO `03173_multiple_partition_cols` SELECT
    number,
    number
FROM numbers(100);
...
INSERT INTO `03173_date_parsing` SELECT toString(toDate('2023-04-01') + number)
FROM numbers(20);
...
INSERT INTO `03173_nested_date_parsing` SELECT toString(toDate('2000-01-01') + 10 * number)
FROM numbers(50)
UNION ALL
SELECT toString(toDate('2100-01-01') + 10 * number)
FROM numbers(50);
