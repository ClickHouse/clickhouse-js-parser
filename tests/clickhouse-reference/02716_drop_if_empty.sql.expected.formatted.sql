...
DROP TABLE IF EXISTS CLICKHOUSE_DATABASE_1.data_02716_3;

DROP DATABASE IF EXISTS CLICKHOUSE_DATABASE_1;

CREATE TABLE data_02716_1
(
    v UInt64
)
ENGINE = MergeTree()
...
CREATE TABLE CLICKHOUSE_DATABASE_1.data_02716_3
(
    v UInt64
)
ENGINE = MergeTree()
...
INSERT INTO data_02716_1 SELECT *
FROM `system`.numbers
LIMIT 1;
...
DROP DATABASE IF EMPTY CLICKHOUSE_DATABASE_1; -- { serverError NOT_IMPLEMENTED }
...
WHERE database = 'default'
    AND name IN ('data_02716_1', 'data_02716_2');