...
SELECT sparkbar(3)(event_date, cnt)
FROM spark_bar_test;

SELECT sparkbar(4)(event_date, cnt)
FROM spark_bar_test;

SELECT sparkbar(5)(event_date, cnt)
FROM spark_bar_test;

SELECT sparkbar(6)(event_date, cnt)
FROM spark_bar_test;

SELECT sparkbar(7)(event_date, cnt)
FROM spark_bar_test;

SELECT sparkbar(8)(event_date, cnt)
FROM spark_bar_test;

SELECT sparkbar(9)(event_date, cnt)
FROM spark_bar_test;

SELECT sparkbar(10)(event_date, cnt)
FROM spark_bar_test;

SELECT sparkbar(11)(event_date, cnt)
FROM spark_bar_test;

SELECT sparkbar(11, 2, 5)(event_date, cnt)
FROM spark_bar_test;

SELECT sparkbar(11, 3, 7)(event_date, cnt)
FROM spark_bar_test;

SELECT sparkbar(11, 4, 11)(event_date, cnt)
FROM spark_bar_test;

SELECT sparkbar(11, toDate('2020-01-02'), toDate('2020-01-05'))(event_date, cnt)
FROM spark_bar_test;

SELECT sparkbar(11, toDate('2020-01-03'), toDate('2020-01-07'))(event_date, cnt)
FROM spark_bar_test;

SELECT sparkbar(11, toDate('2020-01-04'), toDate('2020-01-11'))(event_date, cnt)
FROM spark_bar_test;

SELECT sparkbar(2, toDate('2020-01-01'), toDate('2020-01-08'))(event_date, cnt)
FROM spark_bar_test;

SELECT sparkbar(2, toDate('2020-01-02'), toDate('2020-01-09'))(event_date, cnt)
FROM spark_bar_test;

SELECT sparkbar(3, toDate('2020-01-01'), toDate('2020-01-09'))(event_date, cnt)
FROM spark_bar_test;

SELECT sparkbar(3, toDate('2020-01-01'), toDate('2020-01-10'))(event_date, cnt)
FROM spark_bar_test;

SELECT sparkbar(4, toDate('2020-01-01'), toDate('2020-01-08'))(event_date, cnt)
FROM spark_bar_test;

SELECT sparkbar(5, toDate('2020-01-01'), toDate('2020-01-10'))(event_date, cnt)
FROM spark_bar_test;
...
SELECT sparkbar(128)(toUInt64(9223372036854775806), number % 65535)
FROM numbers(100);
...
SELECT sparkbar(1024)(number, number)
FROM numbers(1024);

SELECT sparkbar(1024)(number, 1)
FROM numbers(1024);
...
SELECT sparkbar(10)(number, number)
FROM numbers(18446744073709551615, 7)
FORMAT Null;

SELECT sparkbar(16)(number, number)
FROM numbers(18446744073709551600, 16)
FORMAT Null;