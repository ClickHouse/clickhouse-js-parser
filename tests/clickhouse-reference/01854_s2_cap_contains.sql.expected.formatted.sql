...
SELECT s2CapContains(1157339245694594829, 1., 1157347770437378819);

SELECT s2CapContains(1157339245694594829, 1., 1152921504606846977);
...
SELECT s2CapContains(toUInt64(-1), -1., toUInt64(-1)); -- { serverError BAD_ARGUMENTS }
