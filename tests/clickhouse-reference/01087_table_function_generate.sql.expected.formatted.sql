...
FROM generateRandom('a Array(Int8), d Decimal32(4), c Tuple(DateTime64(3, ''UTC''), UUID)', 1, 10, 2)
LIMIT 10;
...
FROM generateRandom('a Array(Int8), b UInt32, c Nullable(String), d Decimal32(4), e Nullable(Enum16(''h'' = 1, ''w'' = 5 , ''o'' = -200)), f Float64, g Tuple(Date, DateTime(''UTC''), DateTime64(3, ''UTC''), UUID), h FixedString(2)', 10, 5, 3)
LIMIT 10;
...
SELECT *
FROM generateRandom('x UInt64', NULL, 10, 2)
LIMIT 2
FORMAT Null;