...
ENGINE = Buffer(currentDatabase(), test_table_03745, 1, 10, 100, 10000, 1000000, 10000000, 100000000);

INSERT INTO test_buffer_03745;

SELECT
    pool,
    database,
    table,
    table_uuid != toUUIDOrDefault(0) AS has_uuid,
    log_name
FROM `system`.background_schedule_pool
