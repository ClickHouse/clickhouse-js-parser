...
SELECT *
FROM `03591_test`
WHERE throwIf(b = 1, 'Should throw')
SETTINGS optimize_move_to_prewhere = '1'; -- {serverError FUNCTION_THROW_IF_VALUE_IS_NON_ZERO}
...
SETTINGS
    optimize_move_to_prewhere = '1',
    additional_table_filters = [('03591_test', 'a=3')],
    allow_experimental_analyzer = '1';
...
SELECT *
FROM `03591_test`
WHERE throwIf(b = 2, 'Should throw')
SETTINGS optimize_move_to_prewhere = '1'; -- {serverError FUNCTION_THROW_IF_VALUE_IS_NON_ZERO}