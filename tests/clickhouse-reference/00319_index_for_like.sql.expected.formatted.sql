...
SELECT s
FROM index_for_like
WHERE s LIKE 'Hello, World 1%';

SET max_rows_to_read = '1';

SELECT s
FROM index_for_like
WHERE s LIKE 'Hello, World 2%';

SELECT s
FROM index_for_like
WHERE s LIKE 'Hello, Worle%';

SELECT s
FROM index_for_like
WHERE s LIKE 'Hello, Wor%';
...
SELECT s
FROM index_for_like
WHERE s LIKE 'Hello, Worl_%';

SELECT s
FROM index_for_like
WHERE s LIKE 'Hello, Worl\\_%';
