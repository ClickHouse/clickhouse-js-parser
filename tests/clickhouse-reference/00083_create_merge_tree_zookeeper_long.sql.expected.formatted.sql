...
ENGINE = CollapsingMergeTree(d, (a, b), 111, y);
...
ENGINE = VersionedCollapsingMergeTree(d, (a, b), 111, y, b);
...
ENGINE = SummingMergeTree(d, (a, b), 111);
...
ENGINE = SummingMergeTree(d, (a, b), 111, (y, z));
...
ENGINE = AggregatingMergeTree(d, (a, b), 111);
...
ENGINE = MergeTree(d, sipHash64(a) + b, (a, sipHash64(a) + b), 111);
...
ENGINE = CollapsingMergeTree(d, sipHash64(a) + b, (a, sipHash64(a) + b), 111, y);
...
ENGINE = VersionedCollapsingMergeTree(d, sipHash64(a) + b, (a, sipHash64(a) + b, b), 111, y, b);
...
ENGINE = SummingMergeTree(d, sipHash64(a) + b, (a, sipHash64(a) + b), 111);
...
ENGINE = SummingMergeTree(d, sipHash64(a) + b, (a, sipHash64(a) + b), 111, (y, z));
...
ENGINE = AggregatingMergeTree(d, sipHash64(a) + b, (a, sipHash64(a) + b), 111);
...
ENGINE = ReplicatedMergeTree('/clickhouse/tables/{database}/test_00083/01/replicated_merge_tree/', 'r1', d, (a, b), 111);
...
ENGINE = ReplicatedCollapsingMergeTree('/clickhouse/tables/{database}/test_00083/01/replicated_collapsing_merge_tree/', 'r1', d, (a, b), 111, y);
...
ENGINE = ReplicatedVersionedCollapsingMergeTree('/clickhouse/tables/{database}/test_00083/01/replicated_versioned_collapsing_merge_tree/', 'r1', d, (a, b), 111, y, b);
...
ENGINE = ReplicatedSummingMergeTree('/clickhouse/tables/{database}/test_00083/01/replicated_summing_merge_tree/', 'r1', d, (a, b), 111);
...
ENGINE = ReplicatedSummingMergeTree('/clickhouse/tables/{database}/test_00083/01/replicated_summing_merge_tree_with_list_of_columns_to_sum/', 'r1', d, (a, b), 111, (y, z));
...
ENGINE = ReplicatedCollapsingMergeTree('/clickhouse/tables/{database}/test_00083/01/replicated_collapsing_merge_tree_with_sampling/', 'r1', d, sipHash64(a) + b, (a, sipHash64(a) + b), 111, y);
...
ENGINE = ReplicatedVersionedCollapsingMergeTree('/clickhouse/tables/{database}/test_00083/01/replicated_versioned_collapsing_merge_tree_with_sampling/', 'r1', d, sipHash64(a) + b, (a, sipHash64(a) + b, b), 111, y, b);
...
ENGINE = ReplicatedSummingMergeTree('/clickhouse/tables/{database}/test_00083/01/replicated_summing_merge_tree_with_sampling/', 'r1', d, sipHash64(a) + b, (a, sipHash64(a) + b), 111);
...
ENGINE = ReplicatedSummingMergeTree('/clickhouse/tables/{database}/test_00083/01/replicated_summing_merge_tree_with_sampling_with_list_of_columns_to_sum/', 'r1', d, sipHash64(a) + b, (a, sipHash64(a) + b), 111, (y, z));
...
ENGINE = ReplicatedAggregatingMergeTree('/clickhouse/tables/{database}/test_00083/01/replicated_aggregating_merge_tree_with_sampling/', 'r1', d, sipHash64(a) + b, (a, sipHash64(a) + b), 111);

INSERT INTO merge_tree;

INSERT INTO collapsing_merge_tree;

INSERT INTO versioned_collapsing_merge_tree;

INSERT INTO summing_merge_tree;

INSERT INTO summing_merge_tree_with_list_of_columns_to_sum;

INSERT INTO aggregating_merge_tree;

INSERT INTO merge_tree_with_sampling;

INSERT INTO collapsing_merge_tree_with_sampling;

INSERT INTO versioned_collapsing_merge_tree_with_sampling;

INSERT INTO summing_merge_tree_with_sampling;

INSERT INTO summing_merge_tree_with_sampling_with_list_of_columns_to_sum;

INSERT INTO aggregating_merge_tree_with_sampling;

INSERT INTO replicated_merge_tree;

INSERT INTO replicated_collapsing_merge_tree;

INSERT INTO replicated_versioned_collapsing_merge_tree;

INSERT INTO replicated_summing_merge_tree;

INSERT INTO replicated_summing_merge_tree_with_list_of_columns_to_sum;

INSERT INTO replicated_aggregating_merge_tree;

INSERT INTO replicated_merge_tree_with_sampling;

INSERT INTO replicated_collapsing_merge_tree_with_sampling;

INSERT INTO replicated_versioned_collapsing_merge_tree_with_sampling;

INSERT INTO replicated_summing_merge_tree_with_sampling;
