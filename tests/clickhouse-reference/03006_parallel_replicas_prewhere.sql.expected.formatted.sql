DROP ROW POLICY IF EXISTS url_na_log_policy0 ON url_na_log;
...
CREATE ROW POLICY url_na_log_policy0 ON url_na_log USING DateVisit < '2022-08-11'
OR DateVisit > '2022-08-19' TO default;

INSERT INTO url_na_log SELECT
    209,
    CAST('2022-08-09' AS Date) + toIntervalDay(intDiv(number, 10000))
FROM numbers(130000)
...
SELECT count()
FROM url_na_log
PREWHERE DateVisit >= toFixedString('2022-08-10', 10)
    AND DateVisit <= '2022-08-20'
