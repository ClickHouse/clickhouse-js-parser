...
FROM test_table_for_estimate_compression_ratio; -- { serverError 456 }

SELECT estimateCompressionRatio('zstd', 'lz4')(some_column)
FROM test_table_for_estimate_compression_ratio; -- { serverError 457 }

SELECT estimateCompressionRatio('zstd', 8192)(some_column)
FROM test_table_for_estimate_compression_ratio; -- positive case, should always be 0
...
FROM test_table_for_estimate_compression_ratio; -- { serverError BAD_QUERY_PARAMETER }
