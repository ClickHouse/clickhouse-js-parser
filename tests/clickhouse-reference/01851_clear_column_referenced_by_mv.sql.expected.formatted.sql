...
ALTER TABLE `01851_merge_tree` DROP COLUMN n3; -- { serverError ALTER_OF_COLUMN_IS_FORBIDDEN }

ALTER TABLE `01851_merge_tree` DROP COLUMN n2; -- { serverError ALTER_OF_COLUMN_IS_FORBIDDEN }
