...
SELECT toNullable(toUInt256(321)) AS k
GROUP BY k;
...
SELECT toNullable(toInt256(321)) AS k
GROUP BY k;
...
SELECT toNullable(toInt128(321)) AS k
GROUP BY k;
