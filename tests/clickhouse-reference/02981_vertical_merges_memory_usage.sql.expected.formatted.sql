...
ENGINE = MergeTree()
ORDER BY id
SETTINGS min_bytes_for_wide_part = '0', vertical_merge_algorithm_min_rows_to_activate = '1', vertical_merge_algorithm_min_columns_to_activate = '1', index_granularity = '8192', index_granularity_bytes = '10M', merge_max_block_size = '8192', merge_max_block_size_bytes = '10M';

INSERT INTO t_vertical_merge_memory SELECT
    number,
...
SELECT
    merge_algorithm,
    peak_memory_usage < 500 * 1024 * 1024 ? 'OK' : format('FAIL: memory usage: {}', formatReadableSize(peak_memory_usage))
