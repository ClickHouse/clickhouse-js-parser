...
CREATE DATABASE CLICKHOUSE_DATABASE ON CLUSTER test_shard_localhost
ENGINE = Atomic();
...
ALTER TABLE test3 ON CLUSTER test_shard_localhost ADD COLUMN invalid_column String MATERIALIZED concat(str, 'b' AS a) SETTINGS distributed_ddl_output_mode = 'throw' FORMAT Null; -- { serverError MULTIPLE_EXPRESSIONS_FOR_ALIAS }

ALTER TABLE test3 ON CLUSTER test_shard_localhost ADD COLUMN invalid_column String DEFAULT concat(str, 'b' AS a) SETTINGS distributed_ddl_output_mode = 'throw' FORMAT Null; -- { serverError MULTIPLE_EXPRESSIONS_FOR_ALIAS }

ALTER TABLE test3 ON CLUSTER test_shard_localhost MODIFY COLUMN column_with_codec String ALIAS str SETTINGS distributed_ddl_output_mode = 'throw' FORMAT Null; -- { serverError BAD_ARGUMENTS }
...
ALTER TABLE test4 ADD COLUMN invalid_column String MATERIALIZED concat(str, 'b' AS a) SETTINGS distributed_ddl_output_mode = 'throw' FORMAT Null; -- { serverError MULTIPLE_EXPRESSIONS_FOR_ALIAS }

ALTER TABLE test4 ADD COLUMN invalid_column String DEFAULT concat(str, 'b' AS a) SETTINGS distributed_ddl_output_mode = 'throw' FORMAT Null; -- { serverError MULTIPLE_EXPRESSIONS_FOR_ALIAS }

ALTER TABLE test4 MODIFY COLUMN column_with_codec String ALIAS str SETTINGS distributed_ddl_output_mode = 'throw' FORMAT Null; -- { serverError BAD_ARGUMENTS }

ALTER TABLE test4 ADD COLUMN valid_column_1 String DEFAULT concat(str, 'a' AS a) SETTINGS distributed_ddl_output_mode = 'throw' FORMAT Null;

ALTER TABLE test4 ADD COLUMN valid_column_2 String MATERIALIZED concat(str, 'c' AS c) SETTINGS distributed_ddl_output_mode = 'throw' FORMAT Null;
