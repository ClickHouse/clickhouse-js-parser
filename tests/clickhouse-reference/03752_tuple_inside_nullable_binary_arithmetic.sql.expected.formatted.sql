...
SELECT CAST(tuple(1, 2) AS Nullable(Tuple(Int32, Int32))) + CAST(tuple(3, 4) AS Nullable(Tuple(Int32, Int32)));

SELECT CAST(NULL AS Nullable(Tuple(Int32, Int32))) + CAST(tuple(3, 4) AS Nullable(Tuple(Int32, Int32)));

SELECT CAST(tuple(1, 2) AS Nullable(Tuple(Int32, Int32))) + CAST(NULL AS Nullable(Tuple(Int32, Int32)));
...
SELECT CAST(tuple(2, 3) AS Nullable(Tuple(Int32, Int32))) * CAST(5 AS Nullable(Int32));

SELECT CAST(tuple(2, 3) AS Nullable(Tuple(Int32, Int32))) * CAST(NULL AS Nullable(Int32));
...
SELECT CAST(tuple(10, 20) AS Nullable(Tuple(Int32, Int32))) / CAST(2 AS Nullable(Int32));
...
SELECT CAST(tuple(10, 9) AS Nullable(Tuple(Int32, Int32))) % CAST(3 AS Nullable(Int32));

SELECT CAST(tuple(10, 9) AS Nullable(Tuple(Int32, Int32))) % CAST(NULL AS Nullable(Int32));

SELECT CAST(NULL AS Nullable(Tuple(Int32, Int32))) % CAST(3 AS Nullable(Int32));