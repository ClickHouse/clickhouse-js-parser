...
(
    ...
    INDEX v2_index v2 TYPE minmax() GRANULARITY 1
)
ENGINE = MergeTree()
ORDER BY id
SETTINGS index_granularity = '64', index_granularity_bytes = '0', min_bytes_for_wide_part = '0', min_bytes_for_full_part_storage = '0', max_bytes_to_merge_at_max_space_in_pool = '1', use_const_adaptive_granularity = '1', add_minmax_index_for_numeric_columns = '0';
...
ENGINE = MergeTree()
ORDER BY (x, y)
SETTINGS index_granularity = '100', index_granularity_bytes = '0', min_bytes_for_wide_part = '0', min_bytes_for_full_part_storage = '0', max_bytes_to_merge_at_max_space_in_pool = '1', use_const_adaptive_granularity = '1', add_minmax_index_for_numeric_columns = '0';
