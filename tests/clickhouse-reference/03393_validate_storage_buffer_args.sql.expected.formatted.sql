...
ENGINE = Buffer(x, x, 0, 1, 1, 1, 1, 1, 1); -- {serverError BAD_ARGUMENTS} must be a positive integer
...
ENGINE = Buffer(x, x, 1, 1, -1, 1, 1, 1, 1); -- {serverError BAD_ARGUMENTS} must be non-negative value
