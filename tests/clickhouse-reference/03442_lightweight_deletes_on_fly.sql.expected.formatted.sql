...
DELETE FROM test_deletes WHERE a >= 100
AND a < 200 SETTINGS lightweight_deletes_sync = '1';

ALTER TABLE test_deletes UPDATE b = 1 WHERE a >= 150
AND a < 250 SETTINGS mutations_sync = '0';
