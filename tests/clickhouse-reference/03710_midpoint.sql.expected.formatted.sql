...
SELECT
    midpoint(i8, i16) AS result,
    toTypeName(result) AS type
FROM midpoint_test;

SELECT
    midpoint(ui32, i32) AS result,
    toTypeName(result) AS type
FROM midpoint_test;
...
SELECT
    midpoint(f64, ui16, 122) AS result,
    toTypeName(result) AS type
FROM midpoint_test;
...
SELECT
    midpoint(toDateTime('2025-01-01 00:00:00'), toDateTime('2025-01-03 12:00:00')) AS result,
    toTypeName(result) AS type;
...
SELECT
    midpoint(3, 1.5, NULL) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(NULL, NULL) AS result,
    toTypeName(result) AS type;
...
SELECT
    midpoint(ui8) AS result,
    toTypeName(result) AS type
FROM midpoint_test;

SELECT
    midpoint(d32) AS result,
    toTypeName(result) AS type
FROM midpoint_test;
...
SELECT
    midpoint(materialize(toNullable(1)), 11) AS result,
    toTypeName(result) AS type;
...
SELECT
    midpoint(10, i32) AS result,
    toTypeName(result) AS type
FROM midpoint_test;

SELECT
    midpoint(toNullable(ui8), 11) AS result,
    toTypeName(result) AS type
FROM midpoint_test;

SELECT
    midpoint(ui8, toNullable(11)) AS result,
    toTypeName(result) AS type
FROM midpoint_test;

SELECT
    midpoint(toNullable(ui8), toNullable(11)) AS result,
    toTypeName(result) AS type
FROM midpoint_test;

SELECT
    midpoint(toNullable(1), toNullable(2)) AS result,
    toTypeName(result) AS type;
...
SELECT
    midpoint(11, CAST(NULL AS Nullable(Int32))) AS result,
    toTypeName(result) AS type
FROM numbers(1);

SELECT
    midpoint(CAST(NULL AS Nullable(Int32)), CAST(NULL AS Nullable(Int32))) AS result,
    toTypeName(result) AS type
FROM numbers(1);

SELECT
    midpoint(11, CAST(NULL AS Nullable(Int32)), CAST(NULL AS Nullable(Int32))) AS result,
    toTypeName(result) AS type
FROM numbers(1);
...
SELECT
    midpoint(toNullable(i8), toNullable(i16)) AS result,
    toTypeName(result) AS type
FROM midpoint_test;

SELECT
    midpoint(1, 10) AS result,
    toTypeName(result) AS type;
...
SELECT
    midpoint(toInt64('-1'), toInt64('0')) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(toInt64('-1'), toInt64('-2')) AS result,
    toTypeName(result) AS type;
...
SELECT
    midpoint(CAST(NULL AS Nullable(Int64)), toNullable(toInt64('9223372036854775807')), toNullable(toInt64('9223372036854775807'))) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(toInt128('-170141183460469231731687303715884105728'), toInt128('170141183460469231731687303715884105727')) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(toInt128('170141183460469231731687303715884105727'), toInt128('170141183460469231731687303715884105727')) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(toInt128('-170141183460469231731687303715884105728'), toInt128('-170141183460469231731687303715884105728')) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(toInt128('-1'), toInt128('0')) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(toInt128('-1'), toInt128('-2')) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(toUInt128('0'), toUInt128('340282366920938463463374607431768211455')) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(toUInt128('340282366920938463463374607431768211455'), toUInt128('340282366920938463463374607431768211455')) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(toNullable(toInt128('-170141183460469231731687303715884105728')), toInt128('170141183460469231731687303715884105727')) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(CAST(NULL AS Nullable(Int128)), toInt128('170141183460469231731687303715884105727')) AS result,
    toTypeName(result) AS type;
...
SELECT
    midpoint(toInt128('170141183460469231731687303715884105727'), toInt128('170141183460469231731687303715884105727'), toInt128('170141183460469231731687303715884105727')) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(toUInt128('340282366920938463463374607431768211455'), toUInt128('340282366920938463463374607431768211455'), toUInt128('340282366920938463463374607431768211455')) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(CAST(NULL AS Nullable(Int128)), toNullable(toInt128('170141183460469231731687303715884105727')), toNullable(toInt128('170141183460469231731687303715884105727'))) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(toInt256('170141183460469231731687303715884105727'), toInt256('170141183460469231731687303715884105727')) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(toUInt256('340282366920938463463374607431768211455'), toUInt256('340282366920938463463374607431768211455')) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(toNullable(toInt256('-170141183460469231731687303715884105728')), toInt256('170141183460469231731687303715884105727')) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(CAST(NULL AS Nullable(Int256)), toInt256('170141183460469231731687303715884105727')) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(toNullable(toInt256('-1')), CAST(NULL AS Nullable(Int256))) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(toInt256('170141183460469231731687303715884105727'), toInt256('170141183460469231731687303715884105727'), toInt256('170141183460469231731687303715884105727')) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(toUInt256('340282366920938463463374607431768211455'), toUInt256('340282366920938463463374607431768211455'), toUInt256('340282366920938463463374607431768211455')) AS result,
    toTypeName(result) AS type;
...
SELECT
    midpoint(toUInt256('115792089237316195423570985008687907853269984665640564039457584007913129639935'), toUInt256('115792089237316195423570985008687907853269984665640564039457584007913129639935'), toUInt256('115792089237316195423570985008687907853269984665640564039457584007913129639935')) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(toNullable(toUInt256('115792089237316195423570985008687907853269984665640564039457584007913129639935')), toNullable(toUInt256('115792089237316195423570985008687907853269984665640564039457584007913129639935'))) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(toNullable(toInt256('57896044618658097711785492504343953926634992332820282019728792003956564819967')), toNullable(toInt256('57896044618658097711785492504343953926634992332820282019728792003956564819967'))) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(CAST(NULL AS Nullable(Int256)), toNullable(toInt256('57896044618658097711785492504343953926634992332820282019728792003956564819967')), toNullable(toInt256('57896044618658097711785492504343953926634992332820282019728792003956564819967'))) AS result,
    toTypeName(result) AS type;

SELECT
    midpoint(toDecimal32('999999.999', 3), toDecimal32('999999.999', 3), toDecimal32('999999.999', 3)) AS r,
    toTypeName(r) AS t;
