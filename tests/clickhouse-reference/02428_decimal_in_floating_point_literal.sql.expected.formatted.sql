...
INSERT INTO decimal_in_float_test;
...
SELECT toDecimal32(1.555, 3) IN (1.55, 1.5);
...
SELECT toDecimal64(1.555, 3) IN (1.55, 1.5);
...
SELECT toDecimal128(1.555, 3) IN (1.55, 1.5);
...
SELECT toDecimal256(1.555, 3) IN (1.55, 1.5);

SELECT count() = 1
FROM decimal_in_float_test
WHERE a IN (33);
