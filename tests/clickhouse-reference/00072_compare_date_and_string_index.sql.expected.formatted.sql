...
SELECT count()
FROM test.hits
WHERE EventDate IN ('2014-03-18', '2014-03-19');

SELECT count()
FROM test.hits
WHERE EventDate = toDate('2014-03-18');
...
SELECT count()
FROM test.hits
WHERE EventDate IN (toDate('2014-03-18'), toDate('2014-03-19'));
...
SELECT count()
FROM hits_indexed_by_time
WHERE EventTime IN ('2014-03-18 01:02:03', '2014-03-19 04:05:06');

SELECT count()
FROM hits_indexed_by_time
WHERE EventTime = toDateTime('2014-03-18 01:02:03', 'Asia/Dubai');
...
SELECT count()
FROM hits_indexed_by_time
WHERE EventTime IN (toDateTime('2014-03-18 01:02:03', 'Asia/Dubai'), toDateTime('2014-03-19 04:05:06', 'Asia/Dubai'));
