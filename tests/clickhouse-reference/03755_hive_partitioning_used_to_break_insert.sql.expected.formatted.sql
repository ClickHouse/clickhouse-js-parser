...
INSERT INTO FUNCTION file(currentDatabase() || '_03755_output/date=2019-04-04/path.snappy.parquet', 'Parquet', 'foo_key String, date Date, bar_key String') SETTINGS engine_file_truncate_on_insert = '1' SELECT *
...
SELECT *
FROM file(currentDatabase() || '_03755_output/date=2019-04-04/path.snappy.parquet')
