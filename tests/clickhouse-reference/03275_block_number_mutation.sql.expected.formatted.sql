...
ENGINE = MergeTree()
ORDER BY x
SETTINGS enable_block_number_column = '1', enable_block_offset_column = '0', min_bytes_for_wide_part = '1';

INSERT INTO t_block_number_delete SELECT
    number,
...
WHERE database = currentDatabase()
    AND table = 't_block_number_delete';
...
ENGINE = MergeTree()
ORDER BY x
SETTINGS enable_block_number_column = '1', enable_block_offset_column = '0', min_bytes_for_wide_part = '10G';