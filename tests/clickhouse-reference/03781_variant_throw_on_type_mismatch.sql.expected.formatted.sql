...
CREATE TABLE test_variant_compatible
(
    v Variant(UInt64, Float64)
)
ENGINE = Memory();

INSERT INTO test_variant_compatible;
...
CREATE TABLE test_variant_incompatible
(
    v Variant(UInt64, String)
)
ENGINE = Memory();

INSERT INTO test_variant_incompatible;
...
CREATE TABLE test_variant_array
(
    v Variant(UInt64, Array(String))
)
ENGINE = Memory();

INSERT INTO test_variant_array;
