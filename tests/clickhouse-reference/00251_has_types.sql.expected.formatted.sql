...
SELECT has(materialize([1, 2, 3]), 3.);

SELECT has(materialize([1, 2., 3]), 2);
...
SELECT has([1, 2, 3], materialize(3.));

SELECT has([1, 2., 3], materialize(2));
...
SELECT has(materialize([1, 2, 3]), materialize(3.));

SELECT has(materialize([1, 2., 3]), materialize(2));
