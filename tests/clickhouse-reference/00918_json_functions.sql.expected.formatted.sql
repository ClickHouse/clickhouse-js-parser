...
SELECT
    JSONExtract('{"a":123456.123456}', 'a', 'Decimal(20, 4)') AS a,
    toTypeName(a);
...
SELECT
    JSONExtract('{"a":"123456789012345.12"}', 'a', 'Decimal(30, 4)') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":"1234567890.12345678901234567890", "b":"test"}', 'Tuple(a Decimal(35,20), b LowCardinality(String))') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":"1234567890.123456789012345678901234567890", "b":"test"}', 'Tuple(a Decimal(45,30), b LowCardinality(String))') AS a,
    toTypeName(a);

SELECT
    toDecimal64(123456789012345.12, 4),
...
SELECT
    JSONExtract('{"a":-1234567890}', 'a', 'Int32') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":1234567890}', 'a', 'UInt32') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":-1234567890123456789}', 'a', 'Int64') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":1234567890123456789}', 'a', 'UInt64') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":-1234567890123456789}', 'a', 'Int128') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":1234567890123456789}', 'a', 'UInt128') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":-1234567890123456789}', 'a', 'Int256') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":1234567890123456789}', 'a', 'UInt256') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":-123456789.345}', 'a', 'Int32') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":123456789.345}', 'a', 'UInt32') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":-123456789012.345}', 'a', 'Int64') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":123456789012.345}', 'a', 'UInt64') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":-123456789012.345}', 'a', 'Int128') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":123456789012.345}', 'a', 'UInt128') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":-123456789012.345}', 'a', 'Int256') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":123456789012.345}', 'a', 'UInt256') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":"-123456789"}', 'a', 'Int32') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":"123456789"}', 'a', 'UInt32') AS a,
    toTypeName(a);
...
SELECT
    JSONExtract('{"a":"-12345678901234567890123456789012345678"}', 'a', 'Int128') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":"12345678901234567890123456789012345678"}', 'a', 'UInt128') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":"-11345678901234567890123456789012345678901234567890123456789012345678901234567"}', 'a', 'Int256') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":"11345678901234567890123456789012345678901234567890123456789012345678901234567"}', 'a', 'UInt256') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":"-1234567899999"}', 'a', 'Int32') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":"1234567899999"}', 'a', 'UInt32') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":"-1234567890123456789999"}', 'a', 'Int64') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":"1234567890123456789999"}', 'a', 'UInt64') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":0}', 'a', 'Bool') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a":1}', 'a', 'Bool') AS a,
    toTypeName(a);
...
SELECT
    JSONExtract('{"a": "-2000.22"}', 'a', 'UInt64') AS a,
    toTypeName(a);

SELECT
    JSONExtract('{"a": "-2000.22"}', 'a', 'Int8') AS a,
    toTypeName(a);
...
SELECT JSONExtract(json, 'i', JSONType(json, 'i')); -- { serverError ILLEGAL_COLUMN }
