...
ALTER USER u4_01292 IDENTIFIED BY '123qwe';
...
ALTER USER u1_01292 NOT IDENTIFIED HOST LIKE '%.%.myhost.com' SETTINGS PROFILE default DEFAULT ROLE NONE;
...
CREATE USER u5_01292@'%.host.com', u6_01292@'%.host.com' HOST LIKE '%.host.com';
...
CREATE USER u3_01292 IDENTIFIED BY 'qwe123' HOST LOCAL, IP '192.169.1.1', IP '192.168.0.0/16' DEFAULT ROLE r1_01292;
...
WHERE query NOT LIKE '%query_log%'
    ...
    AND (query LIKE '%qwe123%'
    OR query LIKE '%123qwe%'
    OR query LIKE '%18138372FAD4B94533CD4881F03DC6C69296DD897234E0CEE83F727E2E6B1F63%'
    OR query LIKE '%8DCDD69CE7D121DE8013062AEAEB2A148910D50E%'
    OR query LIKE '%$2a$12$rz5iy2LhuwBezsM88ZzWiemOVUeJ94xHTzwAlLMDhTzwUxOHaY64q%');
...
CREATE USER u1_01292@'192.168.%.%', u2_01292@'192.168.%.%' HOST LIKE '192.168.%.%';
