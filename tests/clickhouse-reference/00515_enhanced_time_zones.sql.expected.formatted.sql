...
CREATE TABLE tab
(
    country LowCardinality(FixedString(7)) DEFAULT 'unknown',
    city LowCardinality(String) DEFAULT 'unknown',
    ...
    device_platform LowCardinality(String) DEFAULT 'unknown',
    ...
    user_id UUID,
    zip FixedString(10) DEFAULT 'unknown',
    timezone LowCardinality(String),
    as_organization LowCardinality(String) DEFAULT 'unknown',
    content_cat Array(String),
    playback_method LowCardinality(String) DEFAULT 'unknown',
    ...
    device_ip FixedString(39) DEFAULT 'unknown',
    ...
    api_framework Array(UInt8),
    click_type LowCardinality(String),
    extensions Array(String),
    media_mime Array(String),
    om_id_partner LowCardinality(String) DEFAULT 'unknown',
    player_capabilities Array(FixedString(12)),
    vast_versions Array(UInt8),
    verification_vendors Array(String),
    ad_play_head String DEFAULT 'unknown',
    ad_serving_id String DEFAULT 'unknown',
    asset_uri String DEFAULT 'unknown',
    content_id String DEFAULT 'unknown',
    content_uri String DEFAULT 'unknown',
