...
WITH CAST([[(0, 0), (100, 0), (100, 100), (0, 100), (0, 0)], [(25, 25), (75, 25), (75, 75), (25, 75), (25, 25)]] AS Polygon) AS poly_with_hole
...
SELECT flipCoordinates(CAST('[[[(0, 0), (10, 0), (10, 10), (0, 10)]], [[(20, 20), (50, 20), (50, 50), (20, 50)],[(30, 30), (50, 50), (50, 30)]]]' AS MultiPolygon));

SELECT
    flipCoordinates(CAST('(1.23, 4.56)' AS Point)),
    [CAST('(1.23, 4.56)' AS Point), CAST('(2.34, 5.67)' AS Point)]::Ring;
