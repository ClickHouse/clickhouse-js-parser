...
CREATE TABLE dis_test_shard_scope
ENGINE = Distributed(test_cluster_one_shard_three_replicas_localhost, currentDatabase(), test_shard_scope);

INSERT INTO test_shard_scope (time_col);
