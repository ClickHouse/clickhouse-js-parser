...
(
    dt LowCardinality(Date),
    col DateTime,
    col2 Nullable(Int256),
    colAlias0 Nullable(DateTime64(3)) ALIAS col,
    colAlias3 Nullable(Int32) ALIAS col3 + colAlias0,
    colAlias1 LowCardinality(UInt16) ALIAS colAlias0 + col2,
