...
export function isNodeType<T extends ASTNodeType>(
  node: WithoutLocations<ASTNode> | undefined,
  type: T,
...
export function isLiteral(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['Literal'] {
...
export function isIdentifier(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['Identifier'] {
...
export function isSubquery(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['Subquery'] {
...
export function isSelectQuery(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['SelectQuery'] {
...
export function isExplainQuery(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['Explain'] {
  return isNodeType(node, 'Explain');
}

/** Type guard for {@link import('./ast').SettingsNode | Settings} nodes. */
export function isSetStatement(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['Settings'] {
...
export function isSetRoleQuery(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['SetRoleQuery'] {
  return isNodeType(node, 'SetRoleQuery');
}

/** Type guard for {@link import('./ast').UseQueryNode | UseQuery} nodes. */
export function isUseQuery(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['UseQuery'] {
...
export function isDetachQuery(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['DetachQuery'] {
...
export function isUndropQuery(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['UndropQuery'] {
...
export function isColumns(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['Columns'] {
...
export function isDataType(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['DataType'] {
...
export function isEnumDataType(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['EnumDataType'] {
...
export function isNameTypePair(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['NameTypePair'] {
...
export function isCollation(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['Collation'] {
...
export function isStorage(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['Storage'] {
...
export function isTTLElement(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['TTLElement'] {
...
export function isConstraint(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['Constraint'] {
...
export function isProjection(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['Projection'] {
...
export function isDictionary(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['Dictionary'] {
...
export function isShowQuery(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['SHOW'] {
  return (
...
export function isAccessQuery(
  node: WithoutLocations<ASTNode> | undefined,
): node is AccessQueryNode {
  return (
...
export function isBackupQuery(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['BackupQuery'] {
...
export function isAssignment(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['Assignment'] {
...
export function isCheckQuery(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['CheckQuery'] {
...
export function isAttachQuery(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['AttachQuery'] {
...
export function isDeleteQuery(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['DeleteQuery'] {
  return isNodeType(node, 'DeleteQuery');
}

/** Type guard for {@link import('./ast').UpdateQueryNode | UpdateQuery} nodes. */
export function isUpdateQuery(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['UpdateQuery'] {
...
export function isEmptyQuery(
  node: WithoutLocations<ASTNode> | undefined,
): node is ASTNodeTypeMap['EmptyQuery'] {
